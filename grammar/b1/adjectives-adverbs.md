...
- [0. Різниця у двох рядках](#0-різниця-у-двох-рядках)
  - [🇺🇦 Українська опора](#-українська-опора)
  - [Тест на 2 секунди](#тест-на-2-секунди)
- [1. Типи прислівників (щоб бачити картину цілком)](#1-типи-прислівників-щоб-бачити-картину-цілком)
- [2. Утворення прислівника: + ly](#2-утворення-прислівника--ly)
  - [Правопис](#правопис)
  - [Прикметники, які САМІ закінчуються на -ly (пастка!)](#прикметники-які-самі-закінчуються-на--ly-пастка)
- [3. Прислівники БЕЗ -ly (форма збігається з прикметником)](#3-прислівники-без--ly-форма-збігається-з-прикметником)
- [4. 🎭 Пари, де -ly МІНЯЄ значення](#4--пари-де--ly-міняє-значення)
  - [Окремо про `hardly` — слово-заперечення](#окремо-про-hardly--слово-заперечення)
  - [good / well](#good--well)
- [5. Позиція прислівника в реченні](#5-позиція-прислівника-в-реченні)
  - [5.1 Прислівники частоти — позиція MID (найважливіше правило)](#51-прислівники-частоти--позиція-mid-найважливіше-правило)
  - [5.2 Ті самі правила — для `probably / definitely / certainly`](#52-ті-самі-правила--для-probably--definitely--certainly)
  - [5.3 Прислівники способу дії (як?) — позиція END](#53-прислівники-способу-дії-як--позиція-end)
  - [5.4 Порядок кількох прислівників у кінці: **M–P–T**](#54-порядок-кількох-прислівників-у-кінці-mpt)
  - [5.5 Підсилювачі — ПЕРЕД словом, яке підсилюють](#55-підсилювачі--перед-словом-яке-підсилюють)
- [6. Порядок прикметників перед іменником](#6-порядок-прикметників-перед-іменником)
- [7. Дієслова стану (linking verbs) → після них ПРИКМЕТНИК](#7-дієслова-стану-linking-verbs--після-них-прикметник)
- [8. Підсилювачі (intensifiers)](#8-підсилювачі-intensifiers)
  - [8.1 Шкала сили](#81-шкала-сили)
  - [8.2 Градуальні vs неградуальні прикметники ⚠️](#82-градуальні-vs-неградуальні-прикметники-)
  - [8.3 so vs such (граматична пара)](#83-so-vs-such-граматична-пара)
  - [8.4 quite — два значення](#84-quite--два-значення)
  - [8.5 too vs very vs enough](#85-too-vs-very-vs-enough)
- [9. Пари -ed / -ing 🎯](#9-пари--ed---ing-)
- [10. Дерево рішень](#10-дерево-рішень)

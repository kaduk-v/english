...
- [7. Дієслова стану (linking verbs) → після них ПРИКМЕТНИК](#_7-дієслова-стану-linking-verbs-→-після-них-прикметник)
  - [look / sound / feel + like + іменник](#look-sound-feel-like-іменник)
...
### look / sound / feel + like + іменник

Той самий linking verb, але після нього стоїть **іменник**, а не прикметник — тоді між ними обов'язково `like`:

| Після дієслова — що? | Схема | Приклад |
|---|---|---|
| прикметник | look / sound / feel + **adj** | This sounds **strange**. — Це звучить дивно. |
| іменник | look / sound / feel + **like** + **noun** | This sounds **like a lie**. — Це звучить як брехня. |

- `like` тут — **прийменник** («як, наче»), а не дієслово «подобатись». Прийменник вимагає після себе іменник (з артиклем!) — тому ❌ sounds like **strange** (прикметник після прийменника неможливий) і ❌ sounds like **lie** (однина злічуваного без артикля).
- 🇺🇦 Підказка: якщо в українській «**як** + іменник» (як брехня, як гарна ідея, як мій брат) → `like` + іменник. Якщо «яким/якою» (дивно, спокійним, втомленим) → прикметник без `like`.
- It looks **like rain**. — Схоже на дощ. · He sounds **like a nice guy**. — Він звучить як хороший хлопець. · I feel **like an idiot**. — Почуваюся ідіотом.

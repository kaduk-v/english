...
## eager
**eager** /ˈiːɡə(r)/ — <code>adjective</code> (прикметник) — нетерплячий (від бажання), охочий, запальний
...
## edge
**edge** /edʒ/ — <code>noun</code> (іменник) — край, грань; лезо; перевага
...
## effective
**effective** /ɪˈfektɪv/ — <code>adjective</code> (прикметник) — ефективний, дієвий (дає потрібний результат)

**Пояснення:** такий, що працює і досягає мети. Питання «чи є результат?», а не «якою ціною він отриманий».

**💡 effective vs efficient (класика):**
- **effective** — ДАЄ РЕЗУЛЬТАТ: скрипт effective, якщо справді знаходить усі дублікати.
- **efficient** — БЕЗ ЗАЙВИХ ВИТРАТ часу/ресурсів: той самий скрипт НЕ efficient, якщо через O(n²) працює годину.
...
## efficient
**efficient** /ɪˈfɪʃnt/ — <code>adjective</code> (прикметник) — ефективний (економний), продуктивний, без зайвих витрат

**Пояснення:** досягає результату з мінімумом часу, ресурсів чи зусиль. Кажуть про код, алгоритми, людей, техніку.
...
## effort
**effort** /ˈefət/ — <code>noun</code> (іменник) — зусилля, старання
...
## embrace
**embrace** /ɪmˈbreɪs/ — 1. <code>verb</code> (дієслово) — обіймати; охоче приймати (ідею, зміни) 2. <code>noun</code> (іменник) — обійми
...
## emphasize
**emphasize** /ˈemfəsaɪz/ — <code>verb</code> (дієслово) — підкреслювати, наголошувати

**Пояснення:** спеціально звертати увагу на щось важливе. У BrE також пишеться emphasise. У твоєму списку слово було у формі минулого часу — **emphasized**. Іменник: **emphasis** /ˈemfəsɪs/ — наголос, акцент.
...
## enclosed
**enclosed** /ɪnˈkləʊzd/ — <code>adjective</code> (прикметник) — 1. закритий, оточений з усіх боків 2. вкладений, доданий (до листа)

**Пояснення:** від дієслова **enclose** (оточувати; вкладати в конверт). An enclosed space — замкнений простір; в офіційних листах — «додано до листа».
...
## encounter
**encounter** /ɪnˈkaʊntə(r)/ — 1. <code>verb</code> (дієслово) 2. <code>noun</code> (іменник) — 1. натрапити, зіткнутися (з труднощами), зустріти несподівано 2. зустріч, зіткнення
...
## endless
**endless** /ˈendləs/ — <code>adjective</code> (прикметник) — нескінченний, безкінечний
...
## endorse
**endorse** /ɪnˈdɔːs/ — <code>verb</code> (дієслово) — публічно підтримувати, схвалювати; рекламувати своїм ім'ям
...
## enforce
**enforce** /ɪnˈfɔːs/ — <code>verb</code> (дієслово) — забезпечувати виконання (правил, закону), примусово впроваджувати
...
## engage
**engage** /ɪnˈɡeɪdʒ/ — <code>verb</code> (дієслово) — залучати, захоплювати (увагу); брати участь; вступати в бій

**Пояснення:** «втягувати» когось у діяльність або взаємодію; про ігри й контент — утримувати увагу (звідси engagement). У військовому/ігровому вжитку: engage the enemy — вступити в бій.

**💡 engage in / with:**
- **engage in** sth — брати участь у діяльності: engage in a discussion.
...
## ensure
**ensure** /ɪnˈʃʊə(r)/ — <code>verb</code> (дієслово) — гарантувати, забезпечувати; подбати, щоб щось точно сталося

**Пояснення:** зробити так, щоб щось напевно відбулося: ensure (that) + речення або ensure + іменник.

**💡 ensure vs insure vs assure:**
- **ensure** — забезпечити результат: Tests **ensure** the app works.
- **insure** /ɪnˈʃʊə(r)/ — застрахувати (поліс, гроші): We **insured** the car.
...
## entire
**entire** /ɪnˈtaɪə(r)/ — <code>adjective</code> (прикметник) — цілий, весь (= whole)
...
## equipment
**equipment** /ɪˈkwɪpmənt/ — <code>noun</code> (іменник) — обладнання; спорядження, екіпірування

**Пояснення:** усі речі, потрібні для якоїсь діяльності: техніка в офісі, спорядження героя в RPG.

**💡 Незлічуване:**
- Без множини і без a: ~~equipments~~, ~~an equipment~~ → some **equipment**, new **equipment**.
...
## essential
**essential** /ɪˈsenʃl/ — <code>adjective</code> (прикметник) — необхідний, найважливіший, ключовий
...
## evaluate
**evaluate** /ɪˈvæljueɪt/ — <code>verb</code> (дієслово) — оцінювати (якість, значення, варіанти)
...
## eventually
**eventually** /ɪˈventʃuəli/ — <code>adverb</code> (прислівник) — врешті-решт, зрештою

**Пояснення:** після довгого часу, затримок чи зусиль — але таки сталося.
...
## evidence
**evidence** /ˈevɪdəns/ — <code>noun</code> (іменник) — доказ(и), свідчення

**Пояснення:** факти, які показують, що щось є правдою (у суді, науці, дебагу).
...
## exactly
**exactly** /ɪɡˈzæktli/ — <code>adverb</code> (прислівник) — точно, саме, рівно
...
## excite
**excite** /ɪkˈsaɪt/ — <code>verb</code> (дієслово) — захоплювати, викликати захват; збуджувати (інтерес)

**Пояснення:** викликати в когось сильні радісні емоції та передчуття.

**💡 Правило -ed / -ing (працює для багатьох пар):**
- **-ed** — що ВІДЧУВАЄ людина: I'm **excited**. — Я в захваті.
- **-ing** — яким Є предмет/подія: The game is **exciting**. — Гра захоплива.
...
## excited
**excited** /ɪkˈsaɪtɪd/ — <code>adjective</code> (прикметник) — у захваті, радісно схвильований
...
## exciting
**exciting** /ɪkˈsaɪtɪŋ/ — <code>adjective</code> (прикметник) — захопливий
...
## exhausted
**exhausted** /ɪɡˈzɔːstɪd/ — <code>adjective</code> (прикметник) — виснажений, украй втомлений
...
## explode
**explode** /ɪkˈspləʊd/ — <code>verb</code> (дієслово) — вибухати; різко зростати
...
## exploit
**exploit** — 1. <code>verb</code> (дієслово) /ɪkˈsplɔɪt/ — використовувати (часто нечесно), експлуатувати 2. <code>noun</code> (іменник) /ˈeksplɔɪt/ — експлойт (security); подвиг

**Пояснення:** дієслово — використати щось на повну або на свою користь (слабкість, людину, баг). Іменник у безпеці — код чи прийом, який використовує вразливість (vulnerability). Книжне значення іменника — подвиги: the exploits of a hero.
...
## explore
**explore** /ɪkˈsplɔː(r)/ — <code>verb</code> (дієслово) — досліджувати, вивчати, розвідувати
...
## expose
**expose** /ɪkˈspəʊz/ — <code>verb</code> (дієслово) — відкривати (доступ), викривати; залишати незахищеним

**Пояснення:** зробити видимим або доступним те, що було приховане чи захищене. У розробці — «відкрити назовні» API, порт, метод; у житті — викрити таємницю чи скандал.
...
## extremely
**extremely** /ɪkˈstriːmli/ — <code>adverb</code> (прислівник) — надзвичайно, вкрай

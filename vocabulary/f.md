...
## fade
**fade** /feɪd/ — <code>verb</code> (дієслово) — згасати, блякнути, поступово зникати
...
## fault
**fault** /fɔːlt/ — <code>noun</code> (іменник) — 1. вина 2. недолік, вада 3. (тех.) збій, несправність

**Пояснення:** відповідальність за помилку; вада людини або речі; у техніці — несправність чи аварійна помилка виконання.

**💡 Дві мастхев-фрази:**
- **It's my fault.** — Це моя вина. _(визнати помилку; кажемо саме fault)_
...
## feat
**feat** /fiːt/ — <code>noun</code> (іменник) — подвиг, досягнення

**Пояснення:** щось складне й вражаюче, що вдалося зробити. У D&D та RPG **feats** — це особливі таланти/уміння персонажа.
...
## flap
**flap** /flæp/ — 1. <code>verb</code> (дієслово) — махати, лопотіти 2. <code>noun</code> (іменник) — клапан, полог, відкидна кришка
...
## flatness
**flatness** /ˈflætnəs/ — <code>noun</code> (іменник) — рівність, площинність; «пласкість»
...
## flatten
**flatten** /ˈflætn/ — <code>verb</code> (дієслово) — сплющувати, вирівнювати; (прогр.) «розплющувати» вкладену структуру
...
## fluency
**fluency** /ˈfluːənsi/ — <code>noun</code> (іменник) — вільне володіння (мовою), плавність мовлення
...
## foreword
**foreword** /ˈfɔːwɜːd/ — <code>noun</code> (іменник) — передмова (у книжці)

**Пояснення:** короткий вступний текст на початку книжки, який часто пише не автор, а хтось інший. Буквально: fore (перед) + word (слово).
...
## forge
**forge** /fɔːdʒ/ — 1. <code>verb</code> (дієслово) — кувати; (фігурально) створювати міцний союз/зв'язок 2. <code>verb</code> (дієслово) — підробляти (документ, підпис) 3. <code>noun</code> (іменник) — кузня, горно

**Пояснення:** основне значення — обробляти розжарений метал молотом _(класика фентезі)_; звідси фігуральне «викувати» союз чи дружбу. Друге, зовсім інше значення — виготовляти фальшивку.

**💡 Два обличчя forge:**
- **forge a sword** — викувати меч _(фентезі)_
...
## fortunately
**fortunately** /ˈfɔːtʃənətli/ — <code>adverb</code> (прислівник) — на щастя

**Пояснення:** вставне слово: оцінює все речення як «пощастило». Антонім — **unfortunately** (на жаль).
...
## foundation
**foundation** /faʊnˈdeɪʃn/ — <code>noun</code> (іменник) — 1. фундамент, основа 2. фонд (організація) 3. заснування
...
## fret
**fret** /fret/ — 1. <code>verb</code> (дієслово) — хвилюватися, перейматися 2. <code>noun</code> (іменник) — лад (на грифі гітари)

**Пояснення:** дієслово — нервувати й гризти себе через щось, зазвичай дрібне; іменник — металева поперечка на грифі гітари, що ділить його на лади.
...
## fuel
**fuel** /ˈfjuːəl/ — 1. <code>noun</code> (іменник) — паливо, пальне 2. <code>verb</code> (дієслово) — заправляти; підживлювати, розпалювати (фігурально)
...
## further
**further** /ˈfɜːðə(r)/ — 1. <code>adverb</code> (прислівник) — далі; більше 2. <code>adjective</code> (прикметник) — додатковий, подальший

**Пояснення:** порівняльна форма від **far**; крім відстані, часто означає «більше, додатково»: further information, further questions.

**💡 further vs farther:** **farther** — лише фізична відстань; **further** — і відстань, і переносне «додатковий/далі». Сумніваєшся — бери **further**, воно доречне завжди.
- We walked **farther** into the forest. — Ми зайшли далі в ліс. _(фізична відстань)_

...
## fade
**fade** /feɪd/ — **verb** (дієслово) — згасати, блякнути, поступово зникати
...
## fault
**fault** /fɔːlt/ — **noun** (іменник) — 1. вина 2. недолік, вада 3. (тех.) збій, несправність
...
## feat
**feat** /fiːt/ — **noun** (іменник) — подвиг, досягнення
...
## flap
**flap** /flæp/ — 1. **verb** (дієслово) — махати, лопотіти 2. **noun** (іменник) — клапан, полог, відкидна кришка
...
## flatness
**flatness** /ˈflætnəs/ — **noun** (іменник) — рівність, площинність; «пласкість»
...
## flatten
**flatten** /ˈflætn/ — **verb** (дієслово) — сплющувати, вирівнювати; (прогр.) «розплющувати» вкладену структуру
...
## fluency
**fluency** /ˈfluːənsi/ — **noun** (іменник) — вільне володіння (мовою), плавність мовлення
...
## foreword
**foreword** /ˈfɔːwɜːd/ — **noun** (іменник) — передмова (у книжці)
...
## forge
**forge** /fɔːdʒ/ — 1. **verb** (дієслово) — кувати; (фігурально) створювати міцний союз/зв'язок 2. **verb** (дієслово) — підробляти (документ, підпис) 3. **noun** (іменник) — кузня, горно
...
## fortunately
**fortunately** /ˈfɔːtʃənətli/ — **adverb** (прислівник) — на щастя
...
## foundation
**foundation** /faʊnˈdeɪʃn/ — **noun** (іменник) — 1. фундамент, основа 2. фонд (організація) 3. заснування
...
## fret
**fret** /fret/ — 1. **verb** (дієслово) — хвилюватися, перейматися 2. **noun** (іменник) — лад (на грифі гітари)
...
## fuel
**fuel** /ˈfjuːəl/ — 1. **noun** (іменник) — паливо, пальне 2. **verb** (дієслово) — заправляти; підживлювати, розпалювати (фігурально)
...
## further
**further** /ˈfɜːðə(r)/ — 1. **adverb** (прислівник) — далі; більше 2. **adjective** (прикметник) — додатковий, подальший

...
## gain
**gain** /ɡeɪn/ — 1. <code>verb</code> (дієслово) 2. <code>noun</code> (іменник) — 1. здобувати, набувати, отримувати 2. приріст, вигода

**💡 gain / earn / win:**
- **gain** — поступово набувати: gain experience / weight / access.
- **earn** — заробляти працею: earn money.
...
## gap
**gap** /ɡæp/ — <code>noun</code> (іменник) — прогалина, проміжок, розрив
...
## gate
**gate** /ɡeɪt/ — <code>noun</code> (іменник) — брама, ворота; вихід на посадку (в аеропорту)
...
## give
**give** /ɡɪv/ — <code>verb</code> (дієслово) — _(irregular: give – gave – given)_ — давати, дарувати, надавати

**💡 Дві структури:** **give** sb sth = **give** sth **to** sb — дати комусь щось.
...
## glow
**glow** /ɡləʊ/ — 1. <code>verb</code> (дієслово) — світитися, жевріти 2. <code>noun</code> (іменник) — сяйво, світіння
...
## gossip
**gossip** /ˈɡɒsɪp/ — 1. <code>noun</code> (іменник, uncountable) — плітки 2. <code>verb</code> (дієслово) — пліткувати
...
## grab
**grab** /ɡræb/ — <code>verb</code> (дієслово) — хапати, схопити

**Пояснення:** швидко й різко взяти рукою. У розмовній мові — «швиденько взяти собі»: їжу, каву, місце.
...
## guardian
**guardian** /ˈɡɑːdiən/ — <code>noun</code> (іменник) — охоронець, хранитель; опікун (юридично)
...
## guess
**guess** /ɡes/ — 1. <code>verb</code> (дієслово) — вгадувати, здогадуватися 2. <code>noun</code> (іменник) — здогад, припущення

**Пояснення:** давати відповідь без упевненості — навмання або за інтуїцією.

**💡 Розмовні мастхеви:**
- **I guess...** — мабуть, напевно _(знизуючи плечима)_: I guess you're right. — Мабуть, твоя правда.
...
## guideline
**guideline** /ˈɡaɪdlaɪn/ — <code>noun</code> (іменник) — настанова, рекомендація _(зазвичай у множині: guidelines)_

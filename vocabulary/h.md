...
## hardly
**hardly** /ˈhɑːdli/ — <code>adverb</code> (прислівник) — ледве, майже не

**Пояснення:** несе заперечний зміст «майже ні». Це НЕ прислівник від **hard**! Часті пари: **hardly ever** — майже ніколи; **hardly any** — майже нічого / зовсім мало.

**💡 hardly ≠ hard:** **hard** — і прикметник (важкий), і прислівник (важко, старанно, багато). Прислівник «старанно» — це саме **hard**, а **hardly** — окреме слово з протилежним ефектом:
- He works **hard**. — Він багато/старанно працює.
- He **hardly** works. — Він майже не працює.
...
## hardship
**hardship** /ˈhɑːdʃɪp/ — <code>noun</code> (іменник) — скрута, злигодні, тяжкі випробування
...
## health
**health** /helθ/ — <code>noun</code> (іменник, uncountable) — здоров'я

**💡 Три схожі слова:**
- **health** /helθ/ — іменник «здоров'я»
- **heal** /hiːl/ — дієслово «зцілювати, загоюватися»: *Time **heals**.* — Час лікує.
...
## hermit
**hermit** /ˈhɜːmɪt/ — <code>noun</code> (іменник) — відлюдник, самітник
...
## hinge
**hinge** /hɪndʒ/ — 1. <code>noun</code> (іменник) — завіса (дверна), шарнір 2. <code>verb</code> (дієслово) — **hinge on** — залежати від, триматися на
...
## hoard
**hoard** /hɔːd/ — 1. <code>noun</code> (іменник) — (накопичений) скарб, запаси 2. <code>verb</code> (дієслово) — накопичувати, жадібно запасати

**Пояснення:** великий запас, який хтось збирає і ховає «на потім»; дієслово — збирати такі запаси. Класика фентезі: **dragon's hoard** — скарб дракона.
...
## hold
**hold** /həʊld/ — <code>verb</code> (дієслово) — _(irregular: hold – held – held)_ — 1. тримати 2. проводити (захід) 3. вміщати
...
## hurt
**hurt** /hɜːt/ — <code>verb</code> (дієслово) — _(irregular: hurt – hurt – hurt)_ — 1. боліти 2. завдавати болю, ранити (фізично й емоційно)

**Пояснення:** незмінне в усіх трьох формах. Працює в обидва боки: «щось болить» (my leg hurts) і «хтось робить боляче комусь» (you hurt me) — і про тіло, і про почуття.

**💡 Два боки hurt:**
- щось болить: My back **hurts**. — У мене болить спина.

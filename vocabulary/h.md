...
## hardly
**hardly** /ˈhɑːdli/ — **adverb** (прислівник) — ледве, майже не
...
## hardship
**hardship** /ˈhɑːdʃɪp/ — **noun** (іменник) — скрута, злигодні, тяжкі випробування
...
## health
**health** /helθ/ — **noun** (іменник, uncountable) — здоров'я
...
## hermit
**hermit** /ˈhɜːmɪt/ — **noun** (іменник) — відлюдник, самітник
...
## hinge
**hinge** /hɪndʒ/ — 1. **noun** (іменник) — завіса (дверна), шарнір 2. **verb** (дієслово) — **hinge on** — залежати від, триматися на
...
## hoard
**hoard** /hɔːd/ — 1. **noun** (іменник) — (накопичений) скарб, запаси 2. **verb** (дієслово) — накопичувати, жадібно запасати
...
## hold
**hold** /həʊld/ — **verb** (дієслово) — _(irregular: hold – held – held)_ — 1. тримати 2. проводити (захід) 3. вміщати
...
## hurt
**hurt** /hɜːt/ — **verb** (дієслово) — _(irregular: hurt – hurt – hurt)_ — 1. боліти 2. завдавати болю, ранити (фізично й емоційно)

...
## late
**late** /leɪt/ — 1. <code>adjective</code> (прикметник) — пізній; який запізнився 2. <code>adverb</code> (прислівник) — пізно, із запізненням

**Пояснення:** після потрібного чи звичного часу. Форма одна і для прикметника, і для прислівника. **be late for** sth — запізнитися на щось.

**💡 late vs lately — ПАРА, не плутай:**
- **late** — пізно / із запізненням: He came **late**. — Він прийшов пізно.
- **lately** — останнім часом (= recently): I've been tired **lately**. — Останнім часом я втомлений.
...
## launch
**launch** /lɔːntʃ/ — 1. <code>verb</code> (дієслово) — запускати (продукт, застосунок, ракету) 2. <code>noun</code> (іменник) — запуск, старт
...
## lay
**lay** /leɪ/ — <code>verb</code> (дієслово) — _(irregular: lay – laid – laid)_ — класти, покласти (щось кудись)

**💡 НЕ плутай `lay` і `lie`:**
- **lay** (lay – laid – laid) — покласти **щось** (потрібен об'єкт): lay the book on the table.
- **lie** (lie – lay – lain) — лежати **самому** (без об'єкта): lie on the sofa.
...
## leadership
**leadership** /ˈliːdəʃɪp/ — <code>noun</code> (іменник, uncountable) — лідерство, керівництво
...
**💡 Сталі фрази:**
- **at least** — принаймні, щонайменше: **at least** ten users.
- **the least** — найменший з усіх: It's **the least** of my problems. — Це найменша з моїх проблем.
...
## legacy
**legacy** /ˈleɡəsi/ — <code>noun</code> (іменник) — спадщина, спадок; (IT) старий, успадкований (про код чи систему)
...
## leverage
**leverage** /ˈliːvərɪdʒ/ _(AmE /ˈlevərɪdʒ/)_ — 1. <code>noun</code> (іменник) 2. <code>verb</code> (дієслово) — 1. важіль впливу, перевага 2. задіювати (ресурс/перевагу) з максимальною віддачею
...
## lifelike
**lifelike** /ˈlaɪflaɪk/ — <code>adjective</code> (прикметник) — реалістичний, як живий

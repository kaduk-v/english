...
## narrow
**narrow** /ˈnærəʊ/ — 1. <code>adjective</code> (прикметник) — вузький 2. <code>verb</code> (дієслово) — звужувати(ся)

**Пояснення:** протилежність до wide. Як дієслово найчастіше у фразі **narrow down** — звузити вибір до кількох варіантів.
...
## negotiate
**negotiate** /nɪˈɡəʊʃieɪt/ — <code>verb</code> (дієслово) — вести переговори, домовлятися

**Пояснення:** обговорювати умови, щоб дійти згоди — про ціну, зарплату, угоду.
...
## negotiation
**negotiation** /nɪˌɡəʊʃiˈeɪʃn/ — <code>noun</code> (іменник) — переговори
...
## never mind
**never mind** /ˌnevə ˈmaɪnd/ — <code>phrase</code> (вираз; зазвичай два слова) — 1. не зважай, забудь 2. нічого страшного
...
## nonetheless
**nonetheless** /ˌnʌnðəˈles/ — <code>adverb</code> (прислівник) — все ж таки, проте, тим не менш

**Пояснення:** з'єднує дві думки, коли друга звучить усупереч першій. Пишеться одним словом.
...
## non-negotiable
**non-negotiable** /ˌnɒn nɪˈɡəʊʃiəbl/ — <code>adjective</code> (прикметник) — що не підлягає обговоренню
...
## nosy
**nosy** /ˈnəʊzi/ — <code>adjective</code> (прикметник) — надто цікавий, той, що пхає носа _(негативно)_
...
## notice
**notice** /ˈnəʊtɪs/ — 1. <code>verb</code> (дієслово) — помічати 2. <code>noun</code> (іменник) — оголошення; попередження
...
## noticeable
**noticeable** /ˈnəʊtɪsəbl/ — <code>adjective</code> (прикметник) — помітний, відчутний

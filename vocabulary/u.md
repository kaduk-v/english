...
## ultimately
**ultimately** /ˈʌltɪmətli/ — **adverb** (прислівник) — зрештою, у кінцевому підсумку
...
## uncover
**uncover** /ʌnˈkʌvə/ — **verb** (дієслово) — розкрити, виявити (приховане); зняти покриття
...
## unintended
**unintended** /ˌʌnɪnˈtendɪd/ — **adjective** (прикметник) — ненавмисний, незапланований
...
## unless
**unless** /ənˈles/ — **conjunction** (сполучник) — якщо не, доки не
...
## upon
**upon** /əˈpɒn/ — **preposition** (прийменник) — формальний варіант **on**: на; при, після (події)
...
## upset
**upset** /ʌpˈset/ — 1. **adjective** (прикметник) — засмучений, розстроєний 2. **verb** (дієслово) — _(irregular: upset – upset – upset)_ — засмутити; порушити (плани, порядок)
...
## upwards
**upwards** /ˈʌpwədz/ — **adverb** (прислівник) — вгору, догори
...
## urgent
**urgent** /ˈɜːdʒənt/ — **adjective** (прикметник) — терміновий, невідкладний
...
## useless
**useless** /ˈjuːsləs/ — **adjective** (прикметник) — марний, некорисний
